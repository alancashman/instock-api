...
exports.addWarehouse = (req, res) => {
    ...
    if (
        ...
        return res
            .status(400)
            .send('Please make sure to provide warehouse name, address, city, country, contact name, position, phone and email fields in a request');
    }
    const newWarehouse = {
        id: id,
    ...
    knex('warehouses')
        ...
        .catch((error) => res.status(400).send(`Error creating Warehouse: ${error}`));
};
